#############################################################################
# Makefile for building: libertycoin-qt
# Generated by qmake (2.01a) (Qt 4.8.5) on: Tue Oct 18 02:42:38 2016
# Project:  libertycoin-qt.pro
# Template: app
# Command: c:\Qt\4.8.5\bin\qmake.exe USE_UPNP=- -o Makefile libertycoin-qt.pro
#############################################################################
...
Makefile: libertycoin-qt.pro  ../Qt/4.8.5/mkspecs/win32-g++/qmake.conf ../Qt/4.8.5/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_UPNP=- -o Makefile libertycoin-qt.pro
...
clean: debug-clean release-clean FORCE
	-$(DEL_FILE) C:/liberytest/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/liberytest/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/liberytest/src/leveldb/libleveldb.a: FORCE
